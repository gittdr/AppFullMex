...
{
    public partial class FullMex : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "swal", "swal('" + msg + "', 'Ingrese los datos correctos', 'error');setTimeout(function(){window.location.href ='FullMex.aspx'}, 4000)", true);
