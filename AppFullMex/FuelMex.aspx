<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FuelMex.aspx.cs" Inherits="AppFullMex.FuelMex" %>
 ...
 <div class="content-wrapper" style="overflow:scroll">
        ...
        <div class="content shadow-lg">
         ...
         <div class="container-fluid mt-4">
                 ...
                 <div class="card" runat="server" id="card1" style="display:block">
                  <div class="card-header">
                    <b>FuelMex | Generar monto</b>
                    ...
                    <div class="row">
                        ...
                        <ContentTemplate>
                                ...
                                <div class="form-group col-sm-12">
                                  <asp:Button ID="Button1" runat="server" Text="Generar" CssClass="btn btn-block btn-success mt-4" OnClick="Button1_Click" />
                                </div>
                                    </div>
                            </div>
                        </div>
